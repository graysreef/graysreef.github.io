...
```{r bsb_area_graph, warning=F, message=F}
...
Area Required to Attain Target Percent qunatity of Scamp Larvae

```{r sp_area_graph, warning=F, message=F}
...
Area Required to Attain Target Percent qunatity of Gag Larvae

```{r gg_area_graph, warning=F, message=F}
